...
for (dataset in databases) {
  ...
  writeArchive("coTrainingMediaStandard.txt", "./", dataName, acc_co, fscore_co,
               preci_co, recall_co, begin, end)
  writeArchive("coTrainingVisao1Standard.txt", "./", dataName, acc_co_v1,
               fscore_co_v1, preci_co_v1, recall_co_v1, begin, end)
  writeArchive("coTrainingVisao2Standard.txt", "./", dataName, acc_co_v2,
               fscore_co_v2, preci_co_v2, recall_co_v2, begin, end)
  ...
  writeArchive("coTrainingMediaDWC.txt", "./", dataName, acc_co, fscore_co,
               preci_co, recall_co, begin, end)
  writeArchive("coTrainingVisao1DWC.txt", "./", dataName, acc_co_v1,
               fscore_co_v1, preci_co_v1, recall_co_v1, begin, end)
  writeArchive("coTrainingVisao2DWC.txt", "./", dataName, acc_co_v2,
               fscore_co_v2, preci_co_v2, recall_co_v2, begin, end)
